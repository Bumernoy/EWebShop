...
namespace WebTester.Controllers
{
    ...
    public class HomeController : BaseController
    {
        ...
        public IEnumerable<string> GetStatistic()
        {
            ...
            IEnumerable<ProductCategories> cats = this.BuildCategoriesService.GetAllIncluding(categories => categories.Realties);
        ...
        public ActionResult Index()
        {
            ...
            IQueryable<Product> realties = this.RealtyService.GetAllIncluding(realty => realty.Owner,
