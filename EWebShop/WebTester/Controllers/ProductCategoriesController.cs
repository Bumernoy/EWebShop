...
namespace BuildSeller.Controllers
{
    ...
    public class ProductCategoriesController : BaseController
    {
        ...
        public ProductCategoriesController(IBuildCategoriesService categoriesService, IRealtyService realtys)
        {
        ...
        [HttpPost]
        public ActionResult Create(ProductCategories cat)
        {
            try
            {
        ...
        [HttpPost]
        public ActionResult Edit(ProductCategories cat)
        {
            try
            {
                if (this.buildCategoriesService.IsUnique(cat))
