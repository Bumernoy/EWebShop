namespace BuildSeller.Controllers
{
    ...
    public class BuildApiController : ApiController
    {
        ...
        public IEnumerable<Product> GetPartOfRealties(int skip, int take)
        {
            return
        ...
        public IEnumerable<Product> GetRealties()
        {
        ...
        {
            Product realt = this.realtyService.Where(c => c.Id == id).FirstOrDefault();
        ...
        public HttpResponseMessage Post([FromBody] string value)
        {
            ...
            if (value != null)
            {
                var realt = JsonConvert.DeserializeObject<Product>(value);
